...
\item Adicionei uma seção sobre a depuração - {\em debug} - no final de cada capítulo.
  ...
  falhas - {\em bugs} -  e alertas sobre armadilhas em Python.
...
e uma melhoria no estilo, no Capítulo 1, e introduziu a discussão
...
\item Lee Harr sugeriu mais correções do que nosso espaço permite para listá-las
...
\item Chris McAloon enviou várias correções para as Seções 3.9 e
3.10.
