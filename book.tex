...
print_lyrics DEF ():
    ...
    print "Eu durmo a noite toda e eu trabalho o dia todo."
\end{verbatim}
%
...
As seções a seguir têm soluções para os exercises, de modo
...
Como de costume, você deve pelo menos tentar os seguintes exercises
...
Modifique o programa do exercise anterior para ler o livro
...
Você deve tentar os exercises anteriores, antes de ir em frente.
...
\index{exercise secreto}
\index{exercise, segredo}
...
a, eu vou dizer o que você precisa saber para os exercises.
Os exemplos de código deste capítulo estão disponíveis a partir
